...
<execution_context>
@C:/project/temp/.claude/get-shit-done/workflows/list-workspaces.md
@C:/project/temp/.claude/get-shit-done/references/ui-brand.md
</execution_context>

<process>
Execute the list-workspaces workflow from @C:/project/temp/.claude/get-shit-done/workflows/list-workspaces.md end-to-end.
</process>
