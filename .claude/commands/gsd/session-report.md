...
<execution_context>
@C:/project/temp/.claude/get-shit-done/workflows/session-report.md
</execution_context>

<process>
Execute the session-report workflow from @C:/project/temp/.claude/get-shit-done/workflows/session-report.md end-to-end.
</process>
