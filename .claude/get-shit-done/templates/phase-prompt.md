...
<!-- For checkpoint task examples and patterns, see @C:/project/temp/.claude/get-shit-done/references/checkpoints.md -->
...
See `C:/project/temp/.claude/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `C:/project/temp/.claude/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `C:/project/temp/.claude/get-shit-done/workflows/verify-phase.md` for verification logic.
