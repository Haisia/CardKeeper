...
Reference full template: `C:/project/temp/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `C:/project/temp/.claude/get-shit-done/templates/state.md`.
